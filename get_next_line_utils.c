...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/28 16:40:56 by thamoliv          #+#    #+#             */
/*   Updated: 2026/07/02 18:44:13 by thamoliv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	gnl_fill_buffer(int fd, char **saved, int *saved_len)
{
	...
	while (!found && bytes_read > 0)
	{
		...
		buffer[bytes_read] = '\0';
		*saved = gnl_strjoin(*saved, *saved_len, buffer, bytes_read);
		*saved_len += bytes_read;
